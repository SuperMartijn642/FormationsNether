        ...
        generator.lootTable("parkour_challenge")
            ...
            .pool(pool ->
                pool.constantRolls(1)
                    .enchantedItemEntry(Items.GOLDEN_SWORD, 20, 35, false, 2)
                    .enchantedItemEntry(Items.GOLDEN_PICKAXE, 20, 35, false, 2)
                    .enchantedItemEntry(Items.GOLDEN_AXE, 20, 35, false, 2)
                    .enchantedItemEntry(Items.GOLDEN_SHOVEL, 20, 35, false, 2)
                    .enchantedItemEntry(Items.GOLDEN_HELMET, 20, 35, false, 2)
                    .enchantedItemEntry(Items.GOLDEN_CHESTPLATE, 20, 35, false, 2)
                    .enchantedItemEntry(Items.GOLDEN_LEGGINGS, 20, 35, false, 2)
                    .enchantedItemEntry(Items.GOLDEN_BOOTS, 20, 35, false, 2)
                    .enchantedItemEntry(Items.IRON_SWORD, 20, 35, false, 1)
                    .enchantedItemEntry(Items.IRON_PICKAXE, 20, 35, false, 1)
                    .enchantedItemEntry(Items.IRON_AXE, 20, 35, false, 1)
                    .enchantedItemEntry(Items.IRON_SHOVEL, 20, 35, false, 1)
                    .enchantedItemEntry(Items.IRON_HELMET, 20, 35, false, 1)
                    .enchantedItemEntry(Items.IRON_CHESTPLATE, 20, 35, false, 1)
                    .enchantedItemEntry(Items.IRON_LEGGINGS, 20, 35, false, 1)
                    .enchantedItemEntry(Items.IRON_BOOTS, 20, 35, false, 1)
                    .enchantedItemEntry(Items.BOW, 20, 35, false, 1)
            );
    }
}
